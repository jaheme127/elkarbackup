...
export SYMFONY__MAILER__AUTH__MODE=${SYMFONY__MAILER__AUTH__MODE:=login}
export SYMFONY__MAILER__PORT=${SYMFONY__MAILER__PORT:=null}
export SYMFONY__MAILER__ENCRYPTION=${SYMFONY__MAILER__ENCRYPTION:=null}
